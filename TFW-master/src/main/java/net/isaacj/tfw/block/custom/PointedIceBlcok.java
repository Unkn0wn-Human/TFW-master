...
public class PointedIceBlock extends Block implements LandingBlock, Waterloggable {
    ...
    public static BlockPos getDripPos(World world, BlockPos pos) {
        ...
        return (BlockPos)searchInDirection(world, pos, Direction.UP.getDirection(), biPredicate, net.minecraft.block.PointedDripstoneBlock::canDrip, 11).orElse((Object)null);
    }

    public static Fluid getDripFluid(World world, BlockPos pos) {
        return (Fluid)getFluid(world, pos, world.getBlockState(pos)).filter(net.minecraft.block.PointedDripstoneBlock::isFluidLiquid).orElse(Fluids.EMPTY);
    }
