...
public enum ModArmorMaterial implements ArmorMaterial {
    ...
    MICENTEAN("micentean", 35, new int[]{2, 5, 7, 2},
            10, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0F, 0.0F,
            () -> Ingredient.ofItems(ModItems.MICENTEAN_INGOT)),

    HEAVY_LEATHER("heavy_leather", 6, new int[]{1, 3, 4, 1},
            20, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.5F, 0.0F,
            () -> Ingredient.ofItems(ModItems.MICENTEAN_INGOT));
