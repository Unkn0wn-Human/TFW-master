package net.isaacj.tfw.world.structures;

import net.isaacj.tfw.TFWmod;
import net.isaacj.tfw.mixin.StructureFeatureAccessor;
...
public class ModStructures {
    ...
    public static void registerStructureFeatures() {
        ...
        StructureFeatureAccessor.callRegister(TFWmod.MOD_ID +
                ":sky_structures", SKY_STRUCTURES, GenerationStep.Feature.SURFACE_STRUCTURES);
    }
}
